export interface MentionedInCommentData {
  name: string;
  authorName: string;
  taskTitle: string;
  taskUrl: string;
...
export function mentionedInCommentTemplate(data: MentionedInCommentData): string {
  const { name, authorName, taskTitle, taskUrl, commentSnippet, workspaceName, appName } = data;
  ...
  return `
    ...
    <html lang="es">
      <head>
        ...
        <title>Te mencionaron: ${taskTitle}</title>
      </head>
          ...
          <tr>
            <td align="center">
              <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background-color:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
                  ...
                  <td style="padding:40px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td align="right">
                          <span style="display:inline-block;padding:2px 10px;font-size:11px;font-weight:600;color:#ef4444;background-color:#fef2f2;border:1px solid #fecaca;border-radius:4px;letter-spacing:0.5px;text-transform:uppercase;">Mención</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:20px 40px 0 40px;">
                    ...
                    <p style="margin:12px 0 0 0;font-size:16px;color:#475569;line-height:1.6;">
                      Hola <strong style="color:#0f172a;">${name}</strong>, <strong style="color:#0f172a;">${authorName}</strong> te ha mencionado en un comentario de la tarea <strong style="color:#0f172a;">${taskTitle}</strong> en <strong style="color:#0f172a;">${workspaceName}</strong>.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border:1px solid #e2e8f0;border-left:4px solid #ef4444;border-radius:8px;">
                      <tr>
                        <td style="padding:16px 20px;">
                          <p style="margin:0;font-size:14px;font-weight:600;color:#0f172a;">${taskTitle}</p>
                          <p style="margin:8px 0 0 0;font-size:13px;color:#64748b;font-style:italic;line-height:1.5;">"${commentSnippet}"</p>
                          <p style="margin:8px 0 0 0;font-size:12px;color:#94a3b8;">— ${authorName}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
