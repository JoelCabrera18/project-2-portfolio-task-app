...
export function loginNotificationTemplate(data: LoginNotificationData): string {
  const { name, email, appName, loginTime, dashboardUrl } = data;
  ...
  return `
    ...
    <html lang="es">
      <head>
        ...
        <title>Inicio de sesión - ${appName}</title>
      </head>
                  ...
                  <td style="padding:40px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td align="right">
                          <span style="display:inline-block;padding:2px 10px;font-size:11px;font-weight:600;color:#059669;background-color:#ecfdf5;border:1px solid #a7f3d0;border-radius:4px;letter-spacing:0.5px;text-transform:uppercase;">Seguridad</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:28px 40px 0 40px;">
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="width:4px;height:28px;background-color:#10b981;border-radius:2px;display:inline-block;vertical-align:top;margin-right:4px;"></td>
                        <td style="width:4px;height:20px;background-color:#10b981;border-radius:2px;display:inline-block;vertical-align:top;margin-right:4px;opacity:0.6;"></td>
                        <td style="width:4px;height:12px;background-color:#10b981;border-radius:2px;display:inline-block;vertical-align:top;opacity:0.3;"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 40px 0 40px;">
                    ...
                    <p style="margin:12px 0 0 0;font-size:16px;color:#475569;line-height:1.6;">
                      Hola <strong style="color:#0f172a;">${name}</strong>, se ha iniciado sesión en tu cuenta de ${appName}.
                    </p>
                  </td>
                </tr>
                          ...
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="padding:0 16px;">
                                ...
                                <p style="margin:2px 0 0 0;font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.5px;">Cuenta</p>
                              </td>
                              <td style="width:1px;background-color:#e2e8f0;padding:0;"></td>
                              <td align="center" style="padding:0 16px;">
                                <p style="margin:0;font-size:20px;font-weight:700;color:#0f172a;">${loginTime.toLocaleString('es-ES', { day: 'numeric', month: 'long', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</p>
                                <p style="margin:2px 0 0 0;font-size:12px;color:#64748b;text-transform:uppercase;letter-spacing:0.5px;">Fecha y hora</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                          ...
                          <table role="presentation" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td style="font-size:13px;color:#991b1b;line-height:1.5;">
                                Si no fuiste tú, te recomendamos cambiar tu contraseña de inmediato y revisar la actividad de tu cuenta.
                              </td>
                            </tr>
                          </table>
                        </td>
                ...
                <tr>
                  <td style="padding:16px 40px 40px 40px;">
                    <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.5;text-align:center;">
                      Este mensaje se envió automáticamente por razones de seguridad.
                      <br />
