...
export function taskCompletedTemplate(data: TaskCompletedData): string {
  const { name, taskTitle, taskUrl, workspaceName, completedByName, appName } = data;
  ...
  return `
    ...
    <html lang="es">
      <head>
        ...
        <title>Tarea completada: ${taskTitle}</title>
      </head>
                  ...
                  <td style="padding:40px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td align="right">
                          <span style="display:inline-block;padding:2px 10px;font-size:11px;font-weight:600;color:#10b981;background-color:#ecfdf5;border:1px solid #a7f3d0;border-radius:4px;letter-spacing:0.5px;text-transform:uppercase;">Completado</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:20px 40px 0 40px;">
                    ...
                    <p style="margin:12px 0 0 0;font-size:16px;color:#475569;line-height:1.6;">
                      Hola <strong style="color:#0f172a;">${name}</strong>, <strong style="color:#0f172a;">${completedByName}</strong> ha marcado como completada una tarea en <strong style="color:#0f172a;">${workspaceName}</strong>.
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;">
                      <tr>
                        <td style="padding:16px 20px;">
                          <p style="margin:0;font-size:16px;font-weight:600;color:#0f172a;text-decoration:line-through;text-decoration-color:#94a3b8;">${taskTitle}</p>
